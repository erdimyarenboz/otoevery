...
.auth-logo { display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 32px; }
.auth-logo-icon {
  width: 38px; height: 38px; background: linear-gradient(135deg, #6366f1, #06b6d4);
...
.auth-type-badge {
  ...
  border-radius: 100px; font-size: 12px; font-weight: 600; color: #818cf8; margin-bottom: 12px;
}
...
.auth-field input {
  ...
  color: #f1f5f9; font-size: 14px; font-family: inherit; outline: none; transition: all 0.2s;
}
.auth-field input:focus { border-color: rgba(99,102,241,0.5); box-shadow: 0 0 0 3px rgba(99,102,241,0.1); }
...
.auth-error { padding: 10px 14px; background: rgba(239,68,68,0.08); border: 1px solid rgba(239,68,68,0.2); border-radius: 8px; color: #f87171; font-size: 13px; }
.auth-btn {
  ...
  cursor: pointer; font-family: inherit; transition: all 0.2s; box-shadow: 0 4px 16px rgba(99,102,241,0.3);
}
.auth-btn:hover { transform: translateY(-1px); }
.auth-btn:disabled { opacity: 0.5; cursor: not-allowed; transform: none; }
.auth-info-box {
  background: rgba(16,185,129,0.06); border: 1px solid rgba(16,185,129,0.15);
  border-radius: 10px; padding: 14px 16px; margin-bottom: 20px; font-size: 13px; color: #94a3b8;
}
.auth-info-box p:first-child { color: #f1f5f9; margin-bottom: 4px; }
...
.auth-divider span { position: relative; background: #1a1d27; padding: 0 12px; font-size: 12px; color: #334155; }
